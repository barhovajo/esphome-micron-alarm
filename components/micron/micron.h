...
namespace esphome
{
  namespace micron
  {
    // Clock signal is 2kHz, so one period is 500 us, low level lasts for 250 us. 
    ...
    static const uint16_t MICRON_KEYPAD_NIGHT_ARM = 0x05; // This is different from the normal arming.
    static const uint16_t MICRON_KEYPAD_EMERGENCY = 0x51; // This is the binary OR of * and #
    ...
    static const uint16_t MICRON_ZONE_6_MASK = 0x20;
    ...
    static const uint16_t MICRON_ZONE_7_MASK = 0x0100;        // But this conflicts with your MICRON_KEY_BEEP_2_MASK  :-(
    ...
    public:
      ...
      void set_fault_binary_sensor(binary_sensor::BinarySensor *fault_binary_sensor) { fault_binary_sensor_ = fault_binary_sensor; }
      void set_nw_armed_binary_sensor(binary_sensor::BinarySensor *nw_armed_binary_sensor) { nw_armed_binary_sensor_ = nw_armed_binary_sensor; }
      void set_nw_unsafe_binary_sensor(binary_sensor::BinarySensor *nw_unsafe_binary_sensor) { nw_unsafe_binary_sensor_ = nw_unsafe_binary_sensor; }
    ...
    protected:
      ...
      binary_sensor::BinarySensor *nw_armed_binary_sensor_{nullptr};
      binary_sensor::BinarySensor *nw_unsafe_binary_sensor_{nullptr};
